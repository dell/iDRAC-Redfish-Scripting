...
parser.add_argument('script_examples',action="store_true",help='ExportFactoryConfigurationREDFISH.py -ip 192.168.0.120 -u root -p calvin --ipaddress 192.168.0.130 --sharetype CIFS --sharename cifs_share_vm --username administrator --password pass --filename R740_factory_inv.xml, this example will export the server factory inventory to a CIFS share')
...
parser.add_argument('--filename', help='Pass in unique file name string for the export factory configuration file', required=False)
...
def loop_job_status():
    ...
    while True:
        ...
        if str(current_time)[0:7] >= "0:05:00":
            ...
            if data[u'Message'] == "Factory Configuration Export was successful":
