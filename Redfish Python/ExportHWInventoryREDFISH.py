...
def export_hw_inventory():
    ...
    """
    global job_id
    url = 'https://%s/redfish/v1/Managers/iDRAC.Embedded.1/Oem/Dell/DellLCService/Actions/DellLCService.ExportHWInventory' % idrac_ip
...
def loop_job_status():
    ...
    while True:
        ...
        if str(current_time)[0:7] >= "0:05:00":
            ...
            sys.exit(0)
        elif data["JobState"] == "Completed" and data["MessageId"] == "LC027":
