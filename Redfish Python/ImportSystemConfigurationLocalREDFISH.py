...
payload = {"ShareParameters":{"Target":"ALL"},"ImportBuffer":"<SystemConfiguration><Component FQDD=\"BIOS.Setup.1-1\"><Attribute Name=\"BiosBootSeq\">HardDisk.List.1-1</Attribute></Component></SystemConfiguration>"}
