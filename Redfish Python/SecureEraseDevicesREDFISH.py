...
parser.add_argument('--secure-erase', help='Pass in device FQDD for secure erase operation. Supported devices are ISE, SED drives or PCIe SSD devices(drives and cards). NOTE: If using iDRAC7 or iDRAC8, only PCIeSSD devices are supported for SecureErase', dest="secure_erase", required=False)
