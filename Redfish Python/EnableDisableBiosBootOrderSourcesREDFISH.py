...
parser.add_argument('-b', help='Enable or disable boot order device. Pass in True to enable or False to Disable. If you are passing in multiple devices for argument -s, pass in the values using comma separator.', required=False)
