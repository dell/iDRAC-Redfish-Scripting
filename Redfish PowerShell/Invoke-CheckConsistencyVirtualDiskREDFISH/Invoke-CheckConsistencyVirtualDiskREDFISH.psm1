...
if ($check_consistency_virtual_disk -ne "")
{
$u1 = "https://$idrac_ip/redfish/v1/Systems/System.Embedded.1/Storage/Volumes/$check_consistency_virtual_disk/Actions/Volume.CheckConsistency"
try
{
...
$j=$j.Replace("}]","")
$current_cc_progress=$j.Split(",")
$operation_value = $zz.Operations

Start-Sleep 10
if ($operation_value.Length -gt 0)
{
Write-Host "`n- PASS, check consistency operation currently in progress. $current_cc_progress"
return
}
else
{
